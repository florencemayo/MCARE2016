	...
	<div class="row">
					...
					<div class="scroll-content">
						<ul class="mini-timeline">
							<li class="mini-timeline-lime">
								...
								<div class="timeline-body">
									<div class="timeline-content">
										<a href="index.html#/" class="name">Vincent Keller</a> added new task <a href="index.html#/">Admin Dashboard UI</a>
										<span class="time">4 mins ago</span>
									</div>
								</div>
							</li>
							...
							<li class="mini-timeline-deeporange">
								...
								<div class="timeline-body">
									<div class="timeline-content">
										<a href="index.html#/" class="name">Shawna Owen</a> added <a href="index.html#/" class="name">Alonzo Keller</a> and <a href="index.html#/" class="name">Mario Bailey</a> to project <a href="index.html#/">Wordpress eCommerce Template</a>
										<span class="time">6 mins ago</span>
									</div>
								</div>
							</li>
							...
							<li class="mini-timeline-info">
								...
								<div class="timeline-body">
									<div class="timeline-content">
										<a href="index.html#/" class="name">Christian Delgado</a> commented on thread <a href="index.html#/">Frontend Template PSD</a>
										<span class="time">12 mins ago</span>
									</div>
								</div>
							</li>
							...
							<li class="mini-timeline-indigo">
								...
								<div class="timeline-body">
									<div class="timeline-content">
										<a href="index.html#/" class="name">Jonathan Smith</a> added <a href="index.html#/" class="name">Frend Pratt</a> and <a href="index.html#/" class="name">Robin Horton</a> to project <a href="index.html#/">Material Design Admin Template</a>
										<span class="time">6 hours ago</span>
									</div>
								</div>
							</li>
		...
		<div class="col-md-3">
			<div class="panel panel-white" data-widget='{"draggable": "false"}'>
				...
				<div class="panel-body">
					<ul class="widget-avatar">
						<li><img src="assets/demo/avatar/avatar_01.png" alt=""/></li>
						<li><img src="assets/demo/avatar/avatar_02.png" alt=""/></li>
						<li><img src="assets/demo/avatar/avatar_03.png" alt=""/></li>
						<li><img src="assets/demo/avatar/avatar_04.png" alt=""/></li>
						<li><img src="assets/demo/avatar/avatar_05.png" alt=""/></li>
					</ul>
			...
			<div class="panel panel-white" data-widget='{"draggable": "false"}'>
				...
				<div class="panel-body">
					<ul class="widget-avatar">
						<li data-status="online"><img src="assets/demo/avatar/avatar_01.png" alt=""/></li>
						<li data-status="online"><img src="assets/demo/avatar/avatar_02.png" alt=""/></li>
						<li data-status="online"><img src="assets/demo/avatar/avatar_03.png" alt=""/></li>
						<li data-status="away"><img src="assets/demo/avatar/avatar_04.png" alt=""/></li>
						<li data-status="busy"><img src="assets/demo/avatar/avatar_05.png" alt=""/></li>
					</ul>
